...
func (f *Favourites) AddAlbum(ctx context.Context, userID, albumId string) error {
	body := url.Values{
		"albumIds":           {albumId},
...
func (f *Favourites) RemoveAlbum(ctx context.Context, userID, albumId string) error {
