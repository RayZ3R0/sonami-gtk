...
func (f *Favourites) AddArtist(ctx context.Context, userID, artistId string) error {
	body := url.Values{
		"artistIds":          {artistId},
...
func (f *Favourites) RemoveArtist(ctx context.Context, userID, artistId string) error {
