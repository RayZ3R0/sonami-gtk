...
func TitleAlbumColumn(track sonami.Track, grid *gtk.Grid, position int, column int32) int {
	frame := VStack(
		Label(sonami.FormatTitle(track)).FontWeight(500).Ellipsis(pango.EllipsizeEndValue).HAlign(gtk.AlignStartValue),
